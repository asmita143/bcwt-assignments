...
function newArticle() {
  ...
  for (let index = 0; index < picArray.length; index++) {
    ...
    h2.textContent = picArray[index].title;
    image.src = picArray[index].filename;
    figCaption.textContent = picArray[index].caption;
    paragraph.textContent = picArray[index].description;
